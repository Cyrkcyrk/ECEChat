...
describe('channels as non members', () => {
	...
	it('get channel1 as user2 (non member, non channelAdmin)', (done) => {
		supertest(app)
	...
	it('Add user2 to channel1 as self (non member, non channelAdmin)', (done) => {
		supertest(app)
	...
	it('Remove user2 from channel1 as self (non member, non channeladmin)', (done) => {
		supertest(app)
	...
	it('Add user2 to adminlist of channel1 as self (non member, non channelAdmin)', (done) => {
		supertest(app)
	...
	it('Remove user2 from adminlist of channel1 as self (non member, channelAdmin)', (done) => {
		supertest(app)
	...
	it('delete channel as user2 (non member, non channelAdmin)', (done) => {
		supertest(app)
